 ...
 * Use the {@link UserAppFragment#newInstance} factory method to
...
RecyclerView recyclerView;
     ...
     * @return A new instance of fragment UserAppFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UserAppFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       recyclerView=view.findViewById(R.id.recyclerview);
        ...
        adapter = new ApkAdapter(installedAppsList,getContext());
